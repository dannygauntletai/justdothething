        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white p-8 rounded-lg shadow">
            ...
            <div className="prose max-w-none">
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4">7. Feedback</h2>
              <p className="mb-4">
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4">12. Governing Law and Jurisdiction</h2>
              <p className="mb-4">
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4">14. Severability</h2>
              <p className="mb-4">
                If any provision of these Terms is held to be invalid or unenforceable, such provision shall be struck and the remaining provisions shall be enforced to the fullest extent under law.
              </p>
              
              <h2 className="text-xl font-semibold mt-6 mb-4">15. Entire Agreement</h2>
              <p className="mb-4">
              ...
              <h2 className="text-xl font-semibold mt-6 mb-4">16. Contact Us</h2>
              <p className="mb-4">
